      ...
      <div>
        ...
        <Container fluid>
          ...
          <Form onSubmit={this.handleSubmit}>
            ...
            <Checkbox name='godkjent' value='ja' label='Godkjent av leder' onChange={this.handleChange} />
            <Input name='leder' label='Leders navn' floatingLabel defaultValue={this.state.leder} onChange={this.handleChange} />
